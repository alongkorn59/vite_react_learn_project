...
import Plan from '../../assets/plan/building/A/BuildingA_001.png'; // Import the Building image


function AFloorPlan1() {
    return (
        <div className='absolute -z-10' style={{ width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', outline: '1px solid green' }}>
            ...
            <g>
                <Link to={"Pano/Type2"} className="building" style={{ position: 'absolute', top: '40%', left: '48.0%', transform: 'translate(-50%, -50%) ' }}>
                    <svg width="150" height="150">
                        <rect id="floor-6" className="highlightA" x="0" y="0" width="150" height="150" />
                    </svg>
                </Link>
                <Link to={"Pano/Type1"} className="building" style={{ position: 'absolute', top: '40%', left: '56.5%', transform: 'translate(-50%, -50%) ' }}>
                    <svg width="150" height="150">
                        <rect id="floor-6" className="highlightA" x="0" y="0" width="150" height="150" />
                    </svg>
                </Link>
