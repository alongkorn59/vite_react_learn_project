...
function BuildingB() {
    return (
        <div className='absolute -z-10' style={{ width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', outline: '1px solid green' }}>
            ...
            <Link to={"BFloorPlan6"} className="building" style={{ position: 'absolute', top: '35%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
                    <rect id="floor-6" className="highlightB" x="0" y="0" width="1250" height="85" />
                </svg>
            </Link>
            <Link to={"BFloorPlan5"} className="building" style={{ position: 'absolute', top: '46%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
                    <rect id="floor-5" className="highlightB" x="0" y="0" width="1250" height="85" />
                </svg>
            </Link>
            <Link to={"BFloorPlan4"} className="building" style={{ position: 'absolute', top: '56.7%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
                    <rect id="floor-4" className="highlightB" x="0" y="0" width="1250" height="85" />
                </svg>
            </Link>
            <Link to={"BFloorPlan3"} className="building" style={{ position: 'absolute', top: '67.5%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
                    <rect id="floor-3" className="highlightB" x="0" y="0" width="1250" height="85" />
                </svg>
            </Link>
            <Link to={"BFloorPlan2"} className="building" style={{ position: 'absolute', top: '78%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
                    <rect id="floor-2" className="highlightB" x="0" y="0" width="1250" height="85" />
                </svg>
            </Link>
            <Link to={"BFloorPlan1"} className="building" style={{ position: 'absolute', top: '89%', left: '50.0%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="1250" height="85">
