...
function BuildMap() {
    return (
        <div className='absolute -z-10' style={{ width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', outline: '1px solid green' }}>
            ...
            <Link to={"buildingA"} className="building" style={{ position: 'absolute', top: '45.3%', left: '18.5%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="625" height="625" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <image href={BuildingA} width="100" height="100" />
                </svg>
            </Link>
            <Link to={"buildingB"} className="building" style={{ position: 'absolute', top: '61.5%', left: '42.8%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="355" height="355" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <image href={BuildingB} width="100" height="100" />
                </svg>
            </Link>
            <Link to={"buildingC"} className="building" style={{ position: 'absolute', top: '61.9%', left: '69.4%', transform: 'translate(-50%, -50%) ' }}>
                <svg width="495" height="495" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <image href={BuildingC} width="100" height="100" />
                </svg>
            </Link>
        </div>
    );
